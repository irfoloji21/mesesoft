...
export class HeaderFourComponent implements OnInit {
  ...
  userInitials: string;
  form:FormGroup;
  constructor(private serviceAuth: AuthService,private formBuilder: FormBuilder, private productService: ProductService ,private router: Router,private route: ActivatedRoute) {
